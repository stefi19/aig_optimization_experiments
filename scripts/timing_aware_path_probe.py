"""Compatibility adapter for :mod:`scripts.analysis.timing_aware_path_probe`.
...
long-standing `python scripts/timing_aware_path_probe.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.timing_aware_path_probe`.
"""
...
_TARGET_MODULE = "scripts.analysis.timing_aware_path_probe"
