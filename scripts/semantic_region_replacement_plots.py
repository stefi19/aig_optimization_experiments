"""Compatibility adapter for :mod:`scripts.visualization.semantic_region_replacement_plots`.
...
long-standing `python scripts/semantic_region_replacement_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.semantic_region_replacement_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.semantic_region_replacement_plots"
