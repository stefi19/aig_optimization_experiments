"""Compatibility adapter for :mod:`scripts.benchmarks.generate_synthetic_benchmarks`.
...
long-standing `python scripts/generate_synthetic_benchmarks.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.benchmarks.generate_synthetic_benchmarks"
