"""Compatibility adapter for :mod:`scripts.benchmarks.benchmark_id`.
...
long-standing `python scripts/benchmark_id.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.benchmarks.benchmark_id`.
"""
...
_TARGET_MODULE = "scripts.benchmarks.benchmark_id"
