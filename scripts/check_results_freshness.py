"""Compatibility adapter for :mod:`scripts.validation.check_results_freshness`.
...
long-standing `python scripts/check_results_freshness.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.validation.check_results_freshness"
