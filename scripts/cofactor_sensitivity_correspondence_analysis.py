"""Compatibility adapter for :mod:`scripts.analysis.cofactor_sensitivity_correspondence_analysis`.
...
long-standing `python scripts/cofactor_sensitivity_correspondence_analysis.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.cofactor_sensitivity_correspondence_analysis`.
"""
...
_TARGET_MODULE = "scripts.analysis.cofactor_sensitivity_correspondence_analysis"
