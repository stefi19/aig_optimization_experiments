"""Compatibility adapter for :mod:`scripts.boundary.recover_equivalence_anchored_boundaries`.
...
long-standing `python scripts/recover_equivalence_anchored_boundaries.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.recover_equivalence_anchored_boundaries`.
"""
...
_TARGET_MODULE = "scripts.boundary.recover_equivalence_anchored_boundaries"
