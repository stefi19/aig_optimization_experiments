"""Compatibility adapter for :mod:`scripts.analysis.approximate_node_distance`.
...
long-standing `python scripts/approximate_node_distance.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.analysis.approximate_node_distance"
