"""Compatibility adapter for :mod:`scripts.publication.build_artifact_manifest`.
...
long-standing `python scripts/build_artifact_manifest.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.publication.build_artifact_manifest`.
"""
...
_TARGET_MODULE = "scripts.publication.build_artifact_manifest"
