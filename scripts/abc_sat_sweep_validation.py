"""Compatibility adapter for :mod:`scripts.abc.abc_sat_sweep_validation`.
...
long-standing `python scripts/abc_sat_sweep_validation.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.abc_sat_sweep_validation`.
"""
...
_TARGET_MODULE = "scripts.abc.abc_sat_sweep_validation"
