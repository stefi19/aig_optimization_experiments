"""Compatibility adapter for :mod:`scripts.abc.probe_yosys_source_metadata`.
...
long-standing `python scripts/probe_yosys_source_metadata.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.probe_yosys_source_metadata`.
"""
...
_TARGET_MODULE = "scripts.abc.probe_yosys_source_metadata"
