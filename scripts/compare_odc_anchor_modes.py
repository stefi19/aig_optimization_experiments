"""Compatibility adapter for :mod:`scripts.materialization.compare_odc_anchor_modes`.
...
long-standing `python scripts/compare_odc_anchor_modes.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.compare_odc_anchor_modes`.
"""
...
_TARGET_MODULE = "scripts.materialization.compare_odc_anchor_modes"
