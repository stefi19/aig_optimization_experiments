"""Compatibility adapter for :mod:`scripts.benchmarks.check_semantic_recovery_benchmarks`.
...
long-standing `python scripts/check_semantic_recovery_benchmarks.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.benchmarks.check_semantic_recovery_benchmarks`.
"""
...
_TARGET_MODULE = "scripts.benchmarks.check_semantic_recovery_benchmarks"
