"""Compatibility adapter for :mod:`scripts.boundary.generate_boundary_recovery_micro_benchmarks`.
...
long-standing `python scripts/generate_boundary_recovery_micro_benchmarks.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.generate_boundary_recovery_micro_benchmarks`.
"""
...
_TARGET_MODULE = "scripts.boundary.generate_boundary_recovery_micro_benchmarks"
