"""Compatibility adapter for :mod:`scripts.analysis.enhanced_critical_path_mapping`.
...
long-standing `python scripts/enhanced_critical_path_mapping.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.enhanced_critical_path_mapping`.
"""
...
_TARGET_MODULE = "scripts.analysis.enhanced_critical_path_mapping"
