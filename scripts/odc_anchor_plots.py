"""Compatibility adapter for :mod:`scripts.visualization.odc_anchor_plots`.
...
long-standing `python scripts/odc_anchor_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.odc_anchor_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.odc_anchor_plots"
