"""Compatibility adapter for :mod:`scripts.materialization.prove_odc_anchors`.
...
long-standing `python scripts/prove_odc_anchors.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.prove_odc_anchors`.
"""
...
_TARGET_MODULE = "scripts.materialization.prove_odc_anchors"
