"""Compatibility adapter for :mod:`scripts.benchmarks.import_real_benchmarks`.
...
long-standing `python scripts/import_real_benchmarks.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.benchmarks.import_real_benchmarks`.
"""
...
_TARGET_MODULE = "scripts.benchmarks.import_real_benchmarks"
