"""Compatibility adapter for :mod:`scripts.validation.check_blind_semantic_results`.
...
long-standing `python scripts/check_blind_semantic_results.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_blind_semantic_results`.
"""
...
_TARGET_MODULE = "scripts.validation.check_blind_semantic_results"
