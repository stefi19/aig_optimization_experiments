"""Compatibility adapter for :mod:`scripts.visualization.active_source_counterpart_plots`.
...
long-standing `python scripts/active_source_counterpart_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.active_source_counterpart_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.active_source_counterpart_plots"
