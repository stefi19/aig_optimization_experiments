"""Compatibility adapter for :mod:`scripts.semantic.select_semantic_expressions`.
...
long-standing `python scripts/select_semantic_expressions.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.select_semantic_expressions`.
"""
...
_TARGET_MODULE = "scripts.semantic.select_semantic_expressions"
