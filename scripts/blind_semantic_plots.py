"""Compatibility adapter for :mod:`scripts.visualization.blind_semantic_plots`.
...
long-standing `python scripts/blind_semantic_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.blind_semantic_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.blind_semantic_plots"
