"""Compatibility adapter for :mod:`scripts.abc.odc_aware_match_probe`.
...
long-standing `python scripts/odc_aware_match_probe.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.odc_aware_match_probe`.
"""
...
_TARGET_MODULE = "scripts.abc.odc_aware_match_probe"
