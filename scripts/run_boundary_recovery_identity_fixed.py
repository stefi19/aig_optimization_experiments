"""Compatibility adapter for :mod:`scripts.boundary.run_boundary_recovery_identity_fixed`.
...
long-standing `python scripts/run_boundary_recovery_identity_fixed.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.run_boundary_recovery_identity_fixed`.
"""
...
_TARGET_MODULE = "scripts.boundary.run_boundary_recovery_identity_fixed"
