"""Compatibility adapter for :mod:`scripts.visualization.semantic_recoverability_plots`.
...
long-standing `python scripts/semantic_recoverability_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.semantic_recoverability_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.semantic_recoverability_plots"
