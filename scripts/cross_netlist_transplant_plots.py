"""Compatibility adapter for :mod:`scripts.visualization.cross_netlist_transplant_plots`.
...
long-standing `python scripts/cross_netlist_transplant_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.cross_netlist_transplant_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.cross_netlist_transplant_plots"
