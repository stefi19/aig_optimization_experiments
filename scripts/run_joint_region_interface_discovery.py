"""Compatibility adapter for :mod:`scripts.recoverability.run_joint_region_interface_discovery`.
...
long-standing `python scripts/run_joint_region_interface_discovery.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_joint_region_interface_discovery`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_joint_region_interface_discovery"
