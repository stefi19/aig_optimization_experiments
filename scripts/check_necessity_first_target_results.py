"""Compatibility adapter for :mod:`scripts.validation.check_necessity_first_target_results`.
...
long-standing `python scripts/check_necessity_first_target_results.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.validation.check_necessity_first_target_results"
