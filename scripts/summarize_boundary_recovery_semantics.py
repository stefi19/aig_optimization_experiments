"""Compatibility adapter for :mod:`scripts.boundary.summarize_boundary_recovery_semantics`.
...
long-standing `python scripts/summarize_boundary_recovery_semantics.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.summarize_boundary_recovery_semantics`.
"""
...
_TARGET_MODULE = "scripts.boundary.summarize_boundary_recovery_semantics"
