"""Compatibility adapter for :mod:`scripts.semantic.simulate_semantic_candidates`.
...
long-standing `python scripts/simulate_semantic_candidates.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.simulate_semantic_candidates`.
"""
...
_TARGET_MODULE = "scripts.semantic.simulate_semantic_candidates"
