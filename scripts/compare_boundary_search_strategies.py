"""Compatibility adapter for :mod:`scripts.boundary.compare_boundary_search_strategies`.
...
long-standing `python scripts/compare_boundary_search_strategies.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.compare_boundary_search_strategies`.
"""
...
_TARGET_MODULE = "scripts.boundary.compare_boundary_search_strategies"
