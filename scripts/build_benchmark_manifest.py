"""Compatibility adapter for :mod:`scripts.benchmarks.build_benchmark_manifest`.
...
long-standing `python scripts/build_benchmark_manifest.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.benchmarks.build_benchmark_manifest"
