"""Compatibility adapter for :mod:`scripts.semantic.verify_semantic_candidates`.
...
long-standing `python scripts/verify_semantic_candidates.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.verify_semantic_candidates`.
"""
...
_TARGET_MODULE = "scripts.semantic.verify_semantic_candidates"
