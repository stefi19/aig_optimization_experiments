"""Compatibility adapter for :mod:`scripts.semantic.generate_semantic_direct_candidates`.
...
long-standing `python scripts/generate_semantic_direct_candidates.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.generate_semantic_direct_candidates`.
"""
...
_TARGET_MODULE = "scripts.semantic.generate_semantic_direct_candidates"
