"""Compatibility adapter for :mod:`scripts.analysis.calibrate_approximate_distance_sampling`.
...
long-standing `python scripts/calibrate_approximate_distance_sampling.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.calibrate_approximate_distance_sampling`.
"""
...
_TARGET_MODULE = "scripts.analysis.calibrate_approximate_distance_sampling"
