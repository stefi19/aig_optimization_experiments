"""Compatibility adapter for :mod:`scripts.boundary.repair_boundary_recovery_cois`.
...
long-standing `python scripts/repair_boundary_recovery_cois.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.repair_boundary_recovery_cois`.
"""
...
_TARGET_MODULE = "scripts.boundary.repair_boundary_recovery_cois"
