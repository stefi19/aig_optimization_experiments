"""Compatibility adapter for :mod:`scripts.visualization.materialized_correspondence_plots`.
...
long-standing `python scripts/materialized_correspondence_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.materialized_correspondence_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.materialized_correspondence_plots"
