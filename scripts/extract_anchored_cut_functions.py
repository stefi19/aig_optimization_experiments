"""Compatibility adapter for :mod:`scripts.materialization.extract_anchored_cut_functions`.
...
long-standing `python scripts/extract_anchored_cut_functions.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.extract_anchored_cut_functions`.
"""
...
_TARGET_MODULE = "scripts.materialization.extract_anchored_cut_functions"
