"""Compatibility adapter for :mod:`scripts.validation.check_research_wow`.
...
long-standing `python scripts/check_research_wow.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_research_wow`.
"""
...
_TARGET_MODULE = "scripts.validation.check_research_wow"
