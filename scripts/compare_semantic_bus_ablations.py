"""Compatibility adapter for :mod:`scripts.semantic.compare_semantic_bus_ablations`.
...
long-standing `python scripts/compare_semantic_bus_ablations.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.compare_semantic_bus_ablations`.
"""
...
_TARGET_MODULE = "scripts.semantic.compare_semantic_bus_ablations"
