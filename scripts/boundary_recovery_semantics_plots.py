"""Compatibility adapter for :mod:`scripts.visualization.boundary_recovery_semantics_plots`.
...
long-standing `python scripts/boundary_recovery_semantics_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.boundary_recovery_semantics_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.boundary_recovery_semantics_plots"
