"""Compatibility adapter for :mod:`scripts.analysis.critical_path_back_mapping`.
...
long-standing `python scripts/critical_path_back_mapping.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.analysis.critical_path_back_mapping"
