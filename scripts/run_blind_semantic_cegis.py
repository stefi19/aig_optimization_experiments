"""Compatibility adapter for :mod:`scripts.semantic.run_blind_semantic_cegis`.
...
long-standing `python scripts/run_blind_semantic_cegis.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.run_blind_semantic_cegis`.
"""
...
_TARGET_MODULE = "scripts.semantic.run_blind_semantic_cegis"
