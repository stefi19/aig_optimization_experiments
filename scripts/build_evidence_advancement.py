"""Compatibility adapter for :mod:`scripts.evidence.build_evidence_advancement`.
...
long-standing `python scripts/build_evidence_advancement.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.evidence.build_evidence_advancement"
