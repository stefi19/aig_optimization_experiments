"""Compatibility adapter for :mod:`scripts.visualization.boundary_diagnosis_plots`.
...
long-standing `python scripts/boundary_diagnosis_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.boundary_diagnosis_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.boundary_diagnosis_plots"
