"""Compatibility adapter for :mod:`scripts.semantic.semantic_z3_cegis_experiment`.
...
long-standing `python scripts/semantic_z3_cegis_experiment.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.semantic_z3_cegis_experiment`.
"""
...
_TARGET_MODULE = "scripts.semantic.semantic_z3_cegis_experiment"
