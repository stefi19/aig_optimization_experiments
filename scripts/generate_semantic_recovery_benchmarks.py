"""Compatibility adapter for :mod:`scripts.benchmarks.generate_semantic_recovery_benchmarks`.
...
long-standing `python scripts/generate_semantic_recovery_benchmarks.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.benchmarks.generate_semantic_recovery_benchmarks`.
"""
...
_TARGET_MODULE = "scripts.benchmarks.generate_semantic_recovery_benchmarks"
