"""Compatibility adapter for :mod:`scripts.analysis.analyze_iscas_verified_matches`.
...
long-standing `python scripts/analyze_iscas_verified_matches.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.analysis.analyze_iscas_verified_matches"
