"""Compatibility adapter for :mod:`scripts.recoverability.run_semantic_functional_refactoring`.
...
long-standing `python scripts/run_semantic_functional_refactoring.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_semantic_functional_refactoring`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_semantic_functional_refactoring"
