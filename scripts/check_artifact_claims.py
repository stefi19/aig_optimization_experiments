"""Compatibility adapter for :mod:`scripts.validation.check_artifact_claims`.
...
long-standing `python scripts/check_artifact_claims.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_artifact_claims`.
"""
...
_TARGET_MODULE = "scripts.validation.check_artifact_claims"
