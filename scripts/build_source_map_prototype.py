"""Compatibility adapter for :mod:`scripts.abc.build_source_map_prototype`.
...
long-standing `python scripts/build_source_map_prototype.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.build_source_map_prototype`.
"""
...
_TARGET_MODULE = "scripts.abc.build_source_map_prototype"
