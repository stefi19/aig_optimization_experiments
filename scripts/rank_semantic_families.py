"""Compatibility adapter for :mod:`scripts.semantic.rank_semantic_families`.
...
long-standing `python scripts/rank_semantic_families.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.rank_semantic_families`.
"""
...
_TARGET_MODULE = "scripts.semantic.rank_semantic_families"
