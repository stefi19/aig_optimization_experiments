"""Compatibility adapter for :mod:`scripts.materialization.materialize_original_wires`.
...
long-standing `python scripts/materialize_original_wires.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.materialize_original_wires`.
"""
...
_TARGET_MODULE = "scripts.materialization.materialize_original_wires"
