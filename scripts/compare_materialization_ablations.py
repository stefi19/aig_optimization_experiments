"""Compatibility adapter for :mod:`scripts.materialization.compare_materialization_ablations`.
...
long-standing `python scripts/compare_materialization_ablations.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.compare_materialization_ablations`.
"""
...
_TARGET_MODULE = "scripts.materialization.compare_materialization_ablations"
