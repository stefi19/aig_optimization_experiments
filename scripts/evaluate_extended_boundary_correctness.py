"""Compatibility adapter for :mod:`scripts.boundary.evaluate_extended_boundary_correctness`.
...
long-standing `python scripts/evaluate_extended_boundary_correctness.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.evaluate_extended_boundary_correctness`.
"""
...
_TARGET_MODULE = "scripts.boundary.evaluate_extended_boundary_correctness"
