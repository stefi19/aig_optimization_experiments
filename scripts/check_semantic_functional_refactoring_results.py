"""Compatibility adapter for :mod:`scripts.validation.check_semantic_functional_refactoring_results`.
...
long-standing `python scripts/check_semantic_functional_refactoring_results.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_semantic_functional_refactoring_results`.
"""
...
_TARGET_MODULE = "scripts.validation.check_semantic_functional_refactoring_results"
