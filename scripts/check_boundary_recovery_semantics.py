"""Compatibility adapter for :mod:`scripts.validation.check_boundary_recovery_semantics`.
...
long-standing `python scripts/check_boundary_recovery_semantics.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_boundary_recovery_semantics`.
"""
...
_TARGET_MODULE = "scripts.validation.check_boundary_recovery_semantics"
