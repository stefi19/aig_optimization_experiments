"""Compatibility adapter for :mod:`scripts.validation.check_evidence_advancement`.
...
long-standing `python scripts/check_evidence_advancement.py` command used in old notes, Makefile
...
_TARGET_MODULE = "scripts.validation.check_evidence_advancement"
