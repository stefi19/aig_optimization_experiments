"""Compatibility adapter for :mod:`scripts.abc.abc_native_sat_sweep_baseline`.
...
long-standing `python scripts/abc_native_sat_sweep_baseline.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.abc_native_sat_sweep_baseline`.
"""
...
_TARGET_MODULE = "scripts.abc.abc_native_sat_sweep_baseline"
