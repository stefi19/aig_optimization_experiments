"""Compatibility adapter for :mod:`scripts.recoverability.run_semantic_recoverability_frontier`.
...
long-standing `python scripts/run_semantic_recoverability_frontier.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_semantic_recoverability_frontier`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_semantic_recoverability_frontier"
