"""Compatibility adapter for :mod:`scripts.visualization.necessity_first_target_plots`.
...
long-standing `python scripts/necessity_first_target_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.necessity_first_target_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.necessity_first_target_plots"
