"""Compatibility adapter for :mod:`scripts.boundary.run_cost_guided_boundary_search`.
...
long-standing `python scripts/run_cost_guided_boundary_search.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.run_cost_guided_boundary_search`.
"""
...
_TARGET_MODULE = "scripts.boundary.run_cost_guided_boundary_search"
