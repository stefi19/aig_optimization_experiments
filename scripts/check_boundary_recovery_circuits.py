"""Compatibility adapter for :mod:`scripts.validation.check_boundary_recovery_circuits`.
...
long-standing `python scripts/check_boundary_recovery_circuits.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.validation.check_boundary_recovery_circuits`.
"""
...
_TARGET_MODULE = "scripts.validation.check_boundary_recovery_circuits"
