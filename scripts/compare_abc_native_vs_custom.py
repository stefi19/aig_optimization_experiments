"""Compatibility adapter for :mod:`scripts.abc.compare_abc_native_vs_custom`.
...
long-standing `python scripts/compare_abc_native_vs_custom.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.compare_abc_native_vs_custom`.
"""
...
_TARGET_MODULE = "scripts.abc.compare_abc_native_vs_custom"
