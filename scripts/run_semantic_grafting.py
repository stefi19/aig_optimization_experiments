"""Compatibility adapter for :mod:`scripts.semantic.run_semantic_grafting`.
...
long-standing `python scripts/run_semantic_grafting.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.run_semantic_grafting`.
"""
...
_TARGET_MODULE = "scripts.semantic.run_semantic_grafting"
