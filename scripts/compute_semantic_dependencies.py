"""Compatibility adapter for :mod:`scripts.semantic.compute_semantic_dependencies`.
...
long-standing `python scripts/compute_semantic_dependencies.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.compute_semantic_dependencies`.
"""
...
_TARGET_MODULE = "scripts.semantic.compute_semantic_dependencies"
