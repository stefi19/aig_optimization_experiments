"""Compatibility adapter for :mod:`scripts.abc.investigate_abc_provenance`.
...
long-standing `python scripts/investigate_abc_provenance.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.investigate_abc_provenance`.
"""
...
_TARGET_MODULE = "scripts.abc.investigate_abc_provenance"
