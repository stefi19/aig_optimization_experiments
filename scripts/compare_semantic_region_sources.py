"""Compatibility adapter for :mod:`scripts.semantic.compare_semantic_region_sources`.
...
long-standing `python scripts/compare_semantic_region_sources.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.compare_semantic_region_sources`.
"""
...
_TARGET_MODULE = "scripts.semantic.compare_semantic_region_sources"
