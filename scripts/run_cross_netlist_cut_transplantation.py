"""Compatibility adapter for :mod:`scripts.recoverability.run_cross_netlist_cut_transplantation`.
...
long-standing `python scripts/run_cross_netlist_cut_transplantation.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_cross_netlist_cut_transplantation`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_cross_netlist_cut_transplantation"
