"""Compatibility adapter for :mod:`scripts.materialization.run_materialized_boundary_recovery`.
...
long-standing `python scripts/run_materialized_boundary_recovery.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.run_materialized_boundary_recovery`.
"""
...
_TARGET_MODULE = "scripts.materialization.run_materialized_boundary_recovery"
