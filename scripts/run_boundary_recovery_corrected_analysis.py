"""Compatibility adapter for :mod:`scripts.boundary.run_boundary_recovery_corrected_analysis`.
...
long-standing `python scripts/run_boundary_recovery_corrected_analysis.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.run_boundary_recovery_corrected_analysis`.
"""
...
_TARGET_MODULE = "scripts.boundary.run_boundary_recovery_corrected_analysis"
