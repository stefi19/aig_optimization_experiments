"""Compatibility adapter for :mod:`scripts.visualization.semantic_dependency_plots`.
...
long-standing `python scripts/semantic_dependency_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.semantic_dependency_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.semantic_dependency_plots"
