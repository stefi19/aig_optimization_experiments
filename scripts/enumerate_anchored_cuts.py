"""Compatibility adapter for :mod:`scripts.materialization.enumerate_anchored_cuts`.
...
long-standing `python scripts/enumerate_anchored_cuts.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.enumerate_anchored_cuts`.
"""
...
_TARGET_MODULE = "scripts.materialization.enumerate_anchored_cuts"
