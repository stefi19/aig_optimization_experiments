"""Compatibility adapter for :mod:`scripts.materialization.generate_odc_anchor_candidates`.
...
long-standing `python scripts/generate_odc_anchor_candidates.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.materialization.generate_odc_anchor_candidates`.
"""
...
_TARGET_MODULE = "scripts.materialization.generate_odc_anchor_candidates"
