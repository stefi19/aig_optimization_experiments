"""Compatibility adapter for :mod:`scripts.abc.probe_abc_sat_sweeping`.
...
long-standing `python scripts/probe_abc_sat_sweeping.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.probe_abc_sat_sweeping`.
"""
...
_TARGET_MODULE = "scripts.abc.probe_abc_sat_sweeping"
