"""Compatibility adapter for :mod:`scripts.visualization.extended_boundary_plots`.
...
long-standing `python scripts/extended_boundary_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.extended_boundary_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.extended_boundary_plots"
