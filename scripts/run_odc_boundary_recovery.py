"""Compatibility adapter for :mod:`scripts.boundary.run_odc_boundary_recovery`.
...
long-standing `python scripts/run_odc_boundary_recovery.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.boundary.run_odc_boundary_recovery`.
"""
...
_TARGET_MODULE = "scripts.boundary.run_odc_boundary_recovery"
