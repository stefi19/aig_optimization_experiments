"""Compatibility adapter for :mod:`scripts.recoverability.run_necessity_first_targets`.
...
long-standing `python scripts/run_necessity_first_targets.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_necessity_first_targets`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_necessity_first_targets"
