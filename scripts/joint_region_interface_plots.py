"""Compatibility adapter for :mod:`scripts.visualization.joint_region_interface_plots`.
...
long-standing `python scripts/joint_region_interface_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.joint_region_interface_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.joint_region_interface_plots"
