"""Compatibility adapter for :mod:`scripts.abc.probe_abc_timing_commands`.
...
long-standing `python scripts/probe_abc_timing_commands.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.abc.probe_abc_timing_commands`.
"""
...
_TARGET_MODULE = "scripts.abc.probe_abc_timing_commands"
