"""Compatibility adapter for :mod:`scripts.semantic.run_semantic_region_replacement`.
...
long-standing `python scripts/run_semantic_region_replacement.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.run_semantic_region_replacement`.
"""
...
_TARGET_MODULE = "scripts.semantic.run_semantic_region_replacement"
