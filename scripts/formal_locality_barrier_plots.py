"""Compatibility adapter for :mod:`scripts.visualization.formal_locality_barrier_plots`.
...
long-standing `python scripts/formal_locality_barrier_plots.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.visualization.formal_locality_barrier_plots`.
"""
...
_TARGET_MODULE = "scripts.visualization.formal_locality_barrier_plots"
