"""Compatibility adapter for :mod:`scripts.recoverability.run_formal_locality_barriers`.
...
long-standing `python scripts/run_formal_locality_barriers.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_formal_locality_barriers`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_formal_locality_barriers"
