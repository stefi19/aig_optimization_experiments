...
| Proof-carrying virtual-anchor synthesis promotes 56/56 source-blind rows after repairing the 36 fresh utility rows into checkpoint-derived replay pairs; 6 former identical-driver cases still require constructive expanded-support graph edits. | `results/evidence_advancement/materialized_replay_pairs.csv`; `results/evidence_advancement/latent_source_cut_bank.csv`; `results/evidence_advancement/optimized_target_decompositions.csv`; `results/evidence_advancement/virtual_anchor_certificates.csv`; `results/evidence_advancement/constructive_rewrite_selection.csv` | proof-carrying source/PI-derived virtual anchors | `python scripts/check_evidence_advancement.py` |
