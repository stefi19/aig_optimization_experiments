"""Compatibility adapter for :mod:`scripts.evidence.build_research_wow`.
...
long-standing `python scripts/build_research_wow.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.evidence.build_research_wow`.
"""
...
_TARGET_MODULE = "scripts.evidence.build_research_wow"
