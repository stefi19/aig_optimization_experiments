"""Compatibility adapter for :mod:`scripts.recoverability.run_active_source_counterpart_refactoring`.
...
long-standing `python scripts/run_active_source_counterpart_refactoring.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.recoverability.run_active_source_counterpart_refactoring`.
"""
...
_TARGET_MODULE = "scripts.recoverability.run_active_source_counterpart_refactoring"
