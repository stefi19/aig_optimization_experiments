"""Compatibility adapter for :mod:`scripts.analysis.contextual_correspondence_analysis`.
...
long-standing `python scripts/contextual_correspondence_analysis.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.contextual_correspondence_analysis`.
"""
...
_TARGET_MODULE = "scripts.analysis.contextual_correspondence_analysis"
