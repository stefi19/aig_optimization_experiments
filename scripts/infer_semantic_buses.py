"""Compatibility adapter for :mod:`scripts.semantic.infer_semantic_buses`.
...
long-standing `python scripts/infer_semantic_buses.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.semantic.infer_semantic_buses`.
"""
...
_TARGET_MODULE = "scripts.semantic.infer_semantic_buses"
