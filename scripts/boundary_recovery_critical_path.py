"""Compatibility adapter for :mod:`scripts.analysis.boundary_recovery_critical_path`.
...
long-standing `python scripts/boundary_recovery_critical_path.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.boundary_recovery_critical_path`.
"""
...
_TARGET_MODULE = "scripts.analysis.boundary_recovery_critical_path"
