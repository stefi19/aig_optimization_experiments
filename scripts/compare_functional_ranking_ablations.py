"""Compatibility adapter for :mod:`scripts.analysis.compare_functional_ranking_ablations`.
...
long-standing `python scripts/compare_functional_ranking_ablations.py` command used in old notes, Makefile
targets, CI logs, and external reproductions while delegating all real work to
`python -m scripts.analysis.compare_functional_ranking_ablations`.
"""
...
_TARGET_MODULE = "scripts.analysis.compare_functional_ranking_ablations"
