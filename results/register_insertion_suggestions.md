...
| --- | --- | --- | --- | --- | --- | --- |
| `external_iscas85_c2670` | `resub` | `new_n856` | `new_n793` | `11/21` | Signature match (`exact_signature_match`) | `1.000` |
| `external_iscas85_c2670` | `rewrite_z` | `new_n856` | `new_n729` | `11/21` | Signature match (`exact_signature_match`) | `1.000` |
| `external_iscas85_c432` | `resub` | `new_n114` | `new_n128` | `21/41` | Signature match (`exact_signature_match`) | `1.000` |
| `external_iscas85_c432` | `rewrite` | `new_n114` | `new_n144` | `21/41` | Signature match (`exact_signature_match`) | `1.000` |
| `external_iscas85_c6288` | `rewrite` | `new_n1143` | `new_n1143` | `59/117` | Signature match (`exact_signature_match`) | `1.000` |
