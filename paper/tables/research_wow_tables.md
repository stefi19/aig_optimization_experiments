...
| necessity_first_graph_rewrites        | generated_research_benchmark     | 0             | 48          | 0.000000     | artifact_absence_audit               |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | ----- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| no_validated_graph_rewrite_artifact                                                                                                                                  | generated_research_benchmark                    | 48    | results/necessity_first_target_discovery/graph_rewrites.csv          | Exact interface evidence is kept separate from graph-rewrite recovery.               |
...
| formal_locality_barrier::no_relevant_source_consumer_window_under_bounds::exact_compact_output_interface_found::exact_compact_output_interface_found                 | no_relevant_source_consumer_window_under_bounds | 3     | results/formal_locality_barriers/failure_taxonomy.csv                | Keep this blocker separate from accepted controlled proof claims.                    |
