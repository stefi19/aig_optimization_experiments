...
| Necessity-first compact interfaces emit 31/48 valid rewrite artifacts, of which 18/48 are graph-active CEC-backed new boundaries. | `results/necessity_first_target_discovery/rewrite_function_synthesis.csv`, `results/necessity_first_target_discovery/boundary_recovery.csv` | `python scripts/check_necessity_first_target_results.py` |
