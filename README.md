...
Proof-carrying virtual-anchor synthesis now promotes 56/56 source-blind rows:
the 36 fresh utility rows are repaired into checkpoint-derived replay pairs,
then all rows receive source/PI-only certificates and graph-active CEC-backed
